...
function App() {
  ...
  // STATE
  // ==========================================
  const [appMode, setAppMode] = useState('ration');
      ...
      {showPinModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <h2>Admin Access</h2>
            <p>Enter your PIN to unlock editing, or continue in view-only mode.</p>
      ...
      <div className="app-container">
        ...
        <header className="app-header">
          <div>
            ...
            <p>Monthly ration planning & family requests</p>
          </div>
          {isAdmin ? (
        ...
        <div className="mode-switcher no-print">
          <button className={`mode-btn ${appMode === 'ration' ? 'active' : ''}`} onClick={() => setAppMode('ration')}>
            Monthly Ration
          </button>
          <button className={`mode-btn ${appMode === 'requests' ? 'active' : ''}`} onClick={() => setAppMode('requests')}>
            Family Requests
          </button>
        </div>
                ...
                <div className="people-grid">
                  {people.map(person => (
                    ...
                    >
                      ...
                      <h3>{person.name}</h3>
                      <div className="balance-amount" style={{ color: person.currentBalance > 0 ? 'var(--green)' : person.currentBalance < 0 ? 'var(--red)' : 'var(--text-muted)' }}>
              ...
              {items.length === 0 ? (
                ...
                <>
                  ...
                  {boughtItems.length > 0 && (
                    <>
                      <div className="section-label" style={{ marginTop: pendingItems.length > 0 ? 'var(--sp-5)' : '0' }}>Bought</div>
                          ...
                          <div className="item-result">
                            ...
                            {isAdmin && (
                              <button
                                ...
                                style={{ marginTop: '4px', padding: '3px 8px', fontSize: '0.72rem' }}
